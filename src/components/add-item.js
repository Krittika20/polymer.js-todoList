...
class AddItem extends LitElement {
    ...
    _onAddItem() {
        if (this.todoItem.length > 0) {
            console.log("sl1: "+ localStorage.getItem('todo-list'));
            ...
            console.log("sl2: "+ storedTodoList);
            storedTodoList = JSON.stringify(storedTodoList)
            localStorage.setItem('todo-list', storedTodoList);
            console.log("sl3: "+ storedTodoList);
            ...
            //     console.log(Object.values(this.todoList[property])[1]);
            //  }
            this.todoItem = '';
          }
    }
        ...
        <div class="container">
            <div class="add">
              ...
              <div class="input-container">
                <input values=${this.todoItem}
                @keyup="${(e) => this.inputKeypress(e)}">
                </input>
                <button class="btn-enter" @click="${()=>this._onAddItem()}">
                  Add Item</button>
            </div>
          </div>
        </div>
